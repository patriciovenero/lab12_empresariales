...
var Button2 = React2.forwardRef((_a, ref) => {
  var _b = _a, {
    as,
    bsPrefix,
    variant,
  ...
  return (0, import_jsx_runtime2.jsx)(Component, __spreadProps(__spreadValues(__spreadValues({}, buttonProps), props), {
    ref,
